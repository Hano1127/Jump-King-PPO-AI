...
CHARGE_BAR_WIDTH_RATIO = 0.25          # 蓄力條最大寬度佔畫面總寬度的比例
CHARGE_BAR_HEIGHT = 2                # 蓄力條的高度 (厚度)
CHARGE_BAR_Y_OFFSET = 2               # 蓄力條距離畫面頂部或底部的垂直距離
CHARGE_BAR_COLOR = (0, 0, 0)     # 蓄力條顏色 (RGB)