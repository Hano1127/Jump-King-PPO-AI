...
class Player:
    ...
    def __init__(self, initial_target_level=0):
        ...
        self.space_bar_processed_for_jump = False 
    ...
    def Jump(self): 
        ...
        self.space_bar_processed_for_jump = True
    ...
    def UpdatePlayerRun(self, lines):
        ...
        if self.jumpHeld and not self.space_bar_processed_for_jump:
            self.velx = 0
            self.isRunning = False
        else:
            if self.rightHeld:
    ...
    def UpdateJumpTimer(self):
        if self.isOnGround and self.jumpHeld:
            if not self.space_bar_processed_for_jump:
    ...
    def GetSpriteToDraw(self):
        ...
        if self.jumpHeld and self.isOnGround and not self.isSliding and not self.space_bar_processed_for_jump: return settings.PLAYER_SQUAT_IMAGE
    ...
    def GetScaledSpriteToDraw(self):
        ...
        if self.jumpHeld and self.isOnGround and not self.isSliding and not self.space_bar_processed_for_jump: return settings.SCALED_PLAYER_SQUAT_IMAGE
